...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers12.min.css" rel="stylesheet"/>', 0);
?>
    ...
    <div class="header12 po-relative">
                ...
                <nav class="navbar navbar-expand-lg font-14">
                    ...
                    <div class="collapse navbar-collapse" id="header12">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-envelope mr-2"></i> admin@naver.com</a></li>
                            <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-phone mr-2"></i>02-1234-5678</a></li>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg hover-dropdown h12-nav">
                ...
                <button class="navbar-toggler text-white" type="button" data-toggle="collapse" data-target="#header12-1" aria-controls="header12-1" aria-expanded="false" aria-label="Toggle navigation">
                    <i class="fas fa-bars"></i>
                </button>
                <div class="collapse navbar-collapse" id="header12-1">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0 font-16 _gnb_all">
                        <!-- 전체메뉴 -->
                        <?php
                        ...
                        <li class="nav-item mb-3">
                            <a class="btn btn-info-gradiant " href="#">Whitepaper</a>
                        </li>
                    -->
                    </ul>
