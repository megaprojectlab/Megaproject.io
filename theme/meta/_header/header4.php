...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers4.min.css" rel="stylesheet"/>', 0);
?>
...
<div class="topbar">
	...
	<!-- Header 4  -->
	<!-- ============================================================== -->
	<div class="header4 po-relative bg-white">
		<div class="h4-topbar">
			<?php include_once(G5_THEME_PATH . '/_inc_temp/btn_temp.php'); ?>
			<div class="container ">
				<nav class="navbar navbar-expand-lg h4-nav">
					<a class="hidden-lg-up">Navigation</a>
					<button class="navbar-toggler text-white _btn-navbar-toggler" type="button" data-toggle="collapse" data-target="#header4" aria-expanded="false" aria-label="Toggle navigation">
						...
						<ul class="navbar-nav ml-auto text-uppercase">
							<li class="nav-item">
								<a class="nav-link b-r">
									<div class="m-r-10"><i class="fas fa-envelope fa-3x text-dark-gradiant"></i></div>
									<div>
										<small>이메일</small>
										<h5 class="">admin@naver.com</h5>
									</div>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link">
									<div class="m-r-10"><i class="fas fa-phone-square fa-3x text-dark-gradiant"></i></div>
									<div>
										<small>고객문의</small>
										<h5 class="">02-1234-5678</h5>
									</div>
								</a>
							</li>
							<li class="nav-item">
