...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers16.min.css" rel="stylesheet"/>', 0);
?>
...
<div class="topbar">
	...
	<!-- Header 16  -->
	<!-- ============================================================== -->
    <div class="header16 po-relative bg-white">
        <!-- Topbar  -->
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="header16a">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-envelope"></i> admin@naver.com</a></li>
                ...
                <nav class="navbar navbar-expand-lg h16-info-bar">
                    ...
                    <div class="collapse navbar-collapse" id="h16-info">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="nav-link">
                                    <div class="m-r-10"><i class="fas fa-clock fa-3x text-danger"></i></div>
                                    <div>
                                        <small>
                                            평일 - <span class="text-dark">09:00-18:00</span><br>
                                            공휴일 - 휴무일
                                        </small>
                                    </div>
                                </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link">
                                    <div class="m-r-10"><i class="fas fa-phone-square fa-3x text-danger"></i></div>
                                    <div>
                                        <small>문의전화</small>
                                        <h5 class="font-bold">02-1234-5678</h5>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="collapse navbar-collapse" id="header16">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item search">
                                <a class="nav-link font-bold" href="javascript:void(0)">
                                    <i class="fas fa-star mr-2" aria-hidden="true"></i>가입신청
                                </a>
                            </li>
                        </ul>
                    </div>
