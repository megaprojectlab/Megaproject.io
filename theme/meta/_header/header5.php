...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers5.min.css" rel="stylesheet"/>', 0);
?>
...
<div class="topbar">
	...
	<!-- Header 5  -->
	<!-- ============================================================== -->
    <div class="header5 bg-dark">
	    <?php include_once(G5_THEME_PATH . '/_inc_temp/btn_temp.php'); ?>
        <div class="container po-relative py-1">
            <nav class="navbar navbar-expand-lg h5-nav-bar">
                ...
                <button class="navbar-toggler text-white" type="button" data-toggle="collapse" data-target="#h5-info" aria-controls="h4-info" aria-expanded="false" aria-label="Toggle navigation"><i class="fas fa-bars"></i></button>
                <div class="collapse navbar-collapse text-uppercase hover-dropdown" id="h5-info">
                    <ul class="navbar-nav m-auto font-16 _gnb_all">
                        <!-- 전체메뉴 -->
	                    <?php
                    ...
                    <div class="rounded-button">
                        <a href="#">로그인</a> - OR - <a href="#">회원가입</a>
                        <a class="ml-3" href="javascript:void(0)" id="gnb-search" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
