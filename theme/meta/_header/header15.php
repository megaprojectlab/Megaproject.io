...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers15.min.css" rel="stylesheet"/>', 0);
?>
...
<div class="topbar">
	...
	<!-- Header 15  -->
	<!-- ============================================================== -->
    <div class="header15 po-relative bg-white">
        <!-- Topbar  -->
                ...
                <nav class="navbar navbar-expand-lg h15-info-bar">
                    ...
                    <div class="collapse navbar-collapse" id="h15-info">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="nav-link">
                                    <div class="m-r-10"><i class="fas fa-map-marker-alt fa-3x"></i></div>
                                    <div><small>경기도 성남시 분당구<br>정자동 123-456</small></div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link">
                                    <div class="m-r-10"><i class="fas fa-phone-square fa-3x"></i></div>
                                    <div><small>문의전화</small>
                                        <h5 class="font-bold">02-1234-5678</h5></div>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="header15">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item search">
                                <a class="nav-link" href="javascript:void(0)"><i class="fa fa-user m-r-10"></i>가입신청</a>
                            </li>
                        </ul>
                    </div>
                </nav>
