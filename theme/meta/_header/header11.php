...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers11.min.css" rel="stylesheet"/>', 0);
?>
...
<div class="topbar">
	...
	<!-- Header 11  -->
	<!-- ============================================================== -->
    <div class="header11 po-relative bg-white">
                ...
                <div class="collapse navbar-collapse hover-dropdown flex-column" id="header11">
                    ...
                    <ul class="navbar-nav ml-auto font-16 _gnb_all">
                        ...
                        <li class="nav-item search dropdown">
                            <a class="nav-link dropdown-toggle font-bold text-themecolor" href="javascript:void(0)" id="gnb-search" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
