...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/headers/headers1.min.css" rel="stylesheet"/>', 0);
?>
...
<div class="topbar">
	...
	<!-- Header 1  -->
	<!-- ============================================================== -->
    <div class="header1 po-relative bg-white">
            ...
            <nav class="navbar navbar-expand-lg h1-nav">
                ...
                <div class="collapse navbar-collapse" id="header1">
                    <div class="hover-dropdown">
                        <ul class="navbar-nav ml-auto mt-2 mt-lg-0 font-16">
                            <!-- 전체메뉴 -->
		                    <?php
...
<!--                                                        <br><a href="--><?php //echo G5_ADMIN_URL; ?><!--/menu_list.php">관리자모드 &gt; 환경설정 &gt; 메뉴설정</a>에서 설정하실 수 있습니다.-->
                            ...
                            <!--<li class="nav-item"><a class="btn btn-outline-success" href="#">바로가기</a></li>-->
