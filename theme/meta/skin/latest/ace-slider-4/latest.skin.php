...
add_stylesheet('<link href="'.G5_THEME_CSS_URL.'/sliders/slider4.min.css" rel="stylesheet"/>', 0);
...
<div class="bg-light">
            ...
            <div id="slider4" class="carousel bs-slider slide  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="7000">
                <ol class="carousel-indicators">
                    ...
                    for ($i=0; $i<$list_count; $i++) {
                        ?>
                        <li data-target="#slider4" data-slide-to="<?php echo $i; ?>" class="<?php echo $i == 0 ? 'active' : '' ?>"></li>
                        <?php
                    }
                    ?>
                </ol>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    ?>
                            ...
                            <div class="carousel-item <?php echo $i == 0 ? 'active' : '' ?>">
                                ...
                                <video class="" style="object-fit: initial; width: 100%; height: <?php echo $thumb_height; ?>px;" autoplay loop muted>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-9 col-lg-7">
                                                <label class="<?php echo $theme_config['slider_cat_color']; ?> font-20 font-bold" data-animation="animated fadeInDown"><?php echo $list[$i]['ca_name']; ?></label>
                                                <h2 data-animation="animated fadeInLeft" class="title <?php echo $theme_config['slider_title_color']; ?> m-b-10">
                    ...
                    <div class="slider-control">
                        <!-- Left Control -->
                        <a class="left carousel-control-prev text-white font-14" href="#slider4" role="button" data-slide="prev">
                            <span class="fas fa-arrow-left fa-2x text-white" aria-hidden="true"></span>
                            <b class="sr-only">이전</b>
                        </a>
                        <!-- Right Control -->
                        <a class="right carousel-control-next text-white font-14" href="#slider4" role="button" data-slide="next">
	...
	<?php if ($list_count == 0) { //게시물이 없을 때  ?>
        <div class="card border mt-0 mb-5">
            <div class="card-body">
                <p class="text-center mb-0 p-5">슬라이더_4에 출력할 내용이 없습니다!</p>
            </div>
        </div>
	<?php }  ?>
</div>
