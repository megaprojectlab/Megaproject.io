...
<div class="mini-spacer feature22">
    <div class="container">
        <?php
	    // 공용 헤드라인 가져오기
	    ...
	    for ($i=0; $i<$list_count; $i++) {
            ...
            $img_content = '<img src="'.$img.'" alt="'.$thumb['alt'].'" class="rounded img-shadow img-responsive">';
	    ?>
            <!-- Row -->
            <div class="row wrap-feature-22 mt-0 mb-5">
                ...
                <div class="col-lg-6">
                    <div class="text-box mt-4">
                        <!--<small class="">
                            <a href="<?php /*echo $list[$i]['ca_name_href'] */?>" class="text-info">
                        ...
                        <p>
                            <a href="<?php echo $list[$i]['href'] ?>">
		                        <?php
		                        echo $_ACETHEME->get_wr_content($list[$i]['wr_content'], 350);
		                        ?>
                            </a>
                        </p>
                    </div>
