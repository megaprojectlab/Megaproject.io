...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-icon-top-link/style.css">', 0);
                ...
                <div class="card card-body mt-4 p-0">
                    <div class="row">
	                    ...
	                    ?>
                            ...
                            <div class="col-lg-4 wrap-feature4-box">
                        ...
                        if (count($list) == 0) {
                        ?>
                            <div class="col-12 wrap-feature4-box">
                                <div class="card">
                                    <div class="card-body">
