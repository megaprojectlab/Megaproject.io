...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-webzine-hori-c1/style.css">', 0);
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-9">
                                            <div class="card-body pt-md-0 pr-md-0">
                                                <h5 class="card-title">
                                                ...
                                                <p class="card-text">
			                                        <?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 500, '..'); ?>
                                                </p>
