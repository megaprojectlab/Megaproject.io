...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-webzine-top-link-m/style.css">', 0);
                ...
                <div class="card card-body mt-4 p-0 feature7">
                    <div class="card-columns">
	                    ...
	                    ?>
                            ...
                            <div class="wrap-feature7-box">
                                <div class="card border" data-aos="flip-left" data-aos-duration="1200">
                                    ...
                                    <div class="card-body text-left <?php echo $list[$i]['is_notice'] ? 'bg-light-warning' : ''; ?>">
                                        ...
                                        <p>
                                            <a href="<?php echo $list[$i]['href'] ?>" class="linking font-weight-bold mb-3">자세히보기 <i class="fas fa-arrow-right"></i></a>
                                        </p>
	                                    <?php
	                                    // 공용 정렬옵션 가져오기
