...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-webzine-right-badge-b/style.css">', 0);
	                    ...
	                    ?>
                            ...
                            <div class="<?php echo $big_head_grid; ?>">
                                <div class="card aos-init aos-animate" data-aos="flip-left" data-aos-duration="1200">
                                    ...
                                    <h<?php echo $is_big_head_first ? '2' : '5' ?> class="mt-3">
	                                    <?php if ($is_checkbox) { ?>
                                    ...
                                    <p class="<?php echo $is_big_head_first ? 'font-22' : ''; ?>">
