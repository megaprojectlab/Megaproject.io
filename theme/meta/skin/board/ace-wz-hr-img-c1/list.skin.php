...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-webzine-hori-img-c1/style.css">', 0);
...
?>
                ...
                <div class="card card-body mt-4 p-0 feature22">
                    ...
                    ?>
                        ...
                        <div class="row wrap-feature-22 mt-0 mb-5">
                            <div class="col-lg-4" data-aos="flip-up" data-aos-duration="1200">
                            ...
                            <div class="col-lg-8">
                                <div class="text-box">
                                    ...
                                    <p>
                                        <a href="<?php echo $list[$i]['href'] ?>">
                                            <?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 150, '..'); ?>
                                        </a>
                                    </p>
                    ...
                    if (count($list) == 0) {
                    ?>
                        <div class="row wrap-feature-22 mt-0">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
