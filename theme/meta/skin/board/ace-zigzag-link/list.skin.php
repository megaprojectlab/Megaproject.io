...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-zigzag-link/style.css">', 0);
...
?>
                ...
                <div class="card card-body mt-4 p-0 feature26">
                    ...
                    ?>
                            <div class="row wrap-feature-26">
                                ...
                                <div class="col-md-6 align-self-center py-3">
                                    ...
                                    <a href="<?php echo $list[$i]['href'] ?>" class="linking font-bold">자세히보기 <i class="fas fa-arrow-right"></i></a>
                                    <div class="my-3">
                                        <?php
                                        // 공용 정렬옵션 가져오기
