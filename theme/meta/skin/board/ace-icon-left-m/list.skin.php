...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-icon-left-m/style.css">', 0);
...
?>
                ...
                <div class="card card-body mt-4 p-0">
                    <div class="card-columns">
	                    ...
	                    ?>
                            ...
                            <div class="wrap-feature5-box">
                                <div class="card border" data-aos="fade-right" data-aos-duration="1200">
                    ...
                    ?>
                        <div class="rows">
                            <div class="col-12 wrap-feature5-box">
                                <div class="card">
                                    <div class="card-body">
