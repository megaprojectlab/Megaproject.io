...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-icon-left-arrow-c2/style.css">', 0);
...
?>
                ...
                <div class="card card-body mt-4 p-0 feature3">
                    <div class="row">
	                    <?php
