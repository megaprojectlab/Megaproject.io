...
add_stylesheet('<link rel="stylesheet" href="'.ACETHEME_SKIN_BOARD_URL.'/ace-gallery-c3-m/style.css">', 0);
                ...
                <div class="card border card-body mt-4 bg-light">
                    <div class="card-columns">
                        ...
                        ?>
                            ...
                            <div class="card border aos-init aos-animate" data-aos="flip-left" data-aos-duration="1200">
                                <a href="<?php echo $list[$i]['href'] ?>" class="img-ho">
                                    <?php
