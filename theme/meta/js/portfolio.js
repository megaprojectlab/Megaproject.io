...
$(function() {
    ...
    $grid.after('<div class="text-center"><a id="load-more" class="btn btn-info btn-md btn-arrow m-t-20" href="javascript:void(0)"> <span>Load More <i class="fas fa-arrow-right"></i></span></a></div>');
